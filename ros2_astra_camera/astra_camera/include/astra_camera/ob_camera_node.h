...
class OBCameraNode {
 ...
 private:
  ...
  // Modification: Added blur_, selective_blur_ and blur_sub_ declarations
  std::atomic<bool> blur_{false};
  std::atomic<bool> selective_blur_{false};
  rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr blur_sub_;
};
